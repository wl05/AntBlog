...
## RPC 工作原理
![image](https://github.com/antbaobao/AntBlog/blob/master/go/imgs/1.png?raw=true)
...
```
接下来让我们来运行程序首先启动服务端程序```go run server.go```然后开启客户端```go run client.go localhost```
...
```
## 参考资料
1. [go web编程](https://learnku.com/index.php/docs/build-web-application-with-golang/084-rpc/3206)
